...
export class MainCarouselComponent  implements OnInit{
  countries = [
    { name: 'CM', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cameroun', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cameroun', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cameroun', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cameroun', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cn', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cameroun', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cameroun', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Caoun', flag: 'assets/img/drapeau1.jpg' },
    { name: 'Cameroun', flag: 'assets/img/drapeau1.jpg' },
